  ...
  <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
    ...
    <span>AI powered Smart Interview Platform</span>
          ...
          <motion.h1
            ...
            className='text-4xl mb:text-6xl font-semibold leading-tight max-w-4xl mx-auto text-center'>
              Practice Interviews with
<span className="block mt-4 bg-green-100 text-green-600 px-6 py-3 rounded-full w-fit mx-auto">
  AI Intelligence
</span>
          </motion.h1>
          <motion.p
    ...
    `}
            ...
            >
               <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg">
      {item.icon}
    </div>
              <div className='pt-10 text-center'>
                <div className='text-xs text-green-600 font-semibold mb-2'>{item.step}</div>
                <h3 className='font-semibold mb-3 text-lg'>{item.title}</h3>
                <p className='text-sm text-gray-500 ledaing-relaxed'>{item.desc}</p>
</div>
          </motion.div>
          ))
          }
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                },
                {
                  ...
                  desc:"Track progess with performance graph and topic analysis."
                }
              ].map((item, index) => (
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                },
                {
                  ...
                  desc:"Unlock premium interview easily."
                }
              ].map((mode, index) => (
                <motion.div key={index}
                  initial={{opacity:0,y:30}}
